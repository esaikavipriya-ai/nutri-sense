...
base_schedule = {
    ...
    "11:00 AM - 11:30 AM": {"Activity": "Mid-Morning Refresh", "Standard": "Elaneer or Neer Mor"},
...
def log_download(name, age, gender, bmi, issues):
    ...
    # Path for your specific project folder
    ...
    # Save the file (creates if missing, appends if exists)
...
if st.session_state.submitted:
    ...
    tab1, tab2 = st.tabs(["📅 Daily Plan", "📥 Download PDF Report"])
    ...
    with tab2:
        ...
        if st.download_button(
            label="📥 Download My NutriSense Report",
            data=pdf_bytes,
            file_name=f"{u['name']}_WellnessReport.pdf",
